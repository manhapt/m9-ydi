...
/**
 * Output an Underscore templates for generating CSS for the color scheme.
 *
 * The templates generates the css dynamically for instant display in the Customizer
 * preview.
 *
 * @since Twenty Fifteen 1.0
 */
